<div class="card-body">
    {!! html()->form('GET', route('order-of-report'))->id('filter-form')->open() !!}
        <div class="row justify-content-end align-items-end">
            ...
            <div class="form-group col-sm-auto text-right">
                <a href="{{ route('order-of-report') }}" class="btn btn-light text-dark pt-2 pb-2">
                    <i class="ri-repeat-line" style="font-size:12px"></i> {{ __('message.reset_filter') }}
                </a>
                <button type="button" class="btn btn-info text-black pt-2 pb-2" data-toggle="modal" data-target="#exportModal">
