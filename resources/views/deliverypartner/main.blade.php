                    ...
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="{{ route('deliverypartner.create') }}" class="btn btn-sm btn-primary jqueryvalidationLoadRemoteModel mr-2">{{ __('message.add_form_title', ['form' => __('message.delivery_partner_benefit')]) }}</a>
                                <a href="{{ route('help-deliverypartner') }}" class="btn btn-xs loadRemoteModel help pt-1 pb-1" role="button">{{ __('message.help') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
