                ...
                <form id="exportForm" method="get">
                    ...
                    <div class="row">
                        <div class="col-md-6 mr-4">
                            @foreach(['traking_id','order_id','name', 'user', 'delivery_man_excel','country_name', 'pickup_date_time_excel', 'delivery_date_time_excel', 'total_amount_excel', 'commission_type_excel', 'admin_commission_excel', 'delivery_man_commission_excel'] as $column)
                                <div class="d-flex">
...
<script>
    $(document).ready(function() {
        ...
        $('#downloadBtn').on('click', function() {
            ...
            var baseUrl = '{{ url('/') }}';
            var route = fileType === 'pdf' ? 'report-of-orderpdf' : 'report-of-orderexcel/' + fileType;
