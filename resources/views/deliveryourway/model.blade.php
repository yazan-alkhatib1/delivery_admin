<?php $id = $id ?? null; ?>
@if (isset($id))
    {{ html()->modelForm($data, 'PATCH', route('deliver-your-way.update', $id))->attribute('enctype','multipart/form-data')->open() }}
@else
    {{ html()->form('POST', route('deliver-your-way.store'))->id('deliver_your_way')->attribute('enctype','multipart/form-data')->open() }} 
@endif
{!! HTML()->hidden('type', 'deliver_your_way') !!}
                ...
                <div class="col-md-2 mb-2">
                    ...
                    @if(isset($id) && getMediaFileExit($data, 'frontend_data_image'))
                        <div class="col-md-2 mb-2 position-relative">
                            <img id="frontend_data_image_preview" src="{{ getSingleMedia($data,'frontend_data_image') }}" class="avatar-100 mt-1">
