        ...
        <div class="row">
                    ...
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            ...
                            <div class="d-flex align-items-center">
                                @if ($count != 3)
                                    <a href="{{ route('deliver-your-way.create') }}"class="float-right  btn btn-sm btn-primary jqueryvalidationLoadRemoteModel mr-2">{{ __('message.deliver_your_way') }}</a>
                                @endif
                                <a href="{{ route('help.deliver.your.way') }}" class="btn btn-xs loadRemoteModel help pt-1 pb-1 mt-1 mb-1"> {{ __('message.help') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                    {{ html()->form()->close() }}
                    {{ html()->form('POST', route('frontend.website.information.update', 'deliver_your_way'))->id('deliverYourWay')->attribute('enctype','multipart/form-data')->open() }}

                        <div class="row">
                            @foreach($deliveryourway as $key => $value)
