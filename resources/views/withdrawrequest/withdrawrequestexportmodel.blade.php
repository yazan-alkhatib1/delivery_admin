...
<div class="modal-dialog modal-lg" id="modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{ __('message.pending_withdraw_request') }}</h5>
            ...
            <form id="exportForm" method="get">
                ...
                <div class="row">
                    <div class="col-md-6 mr-4">
                        @foreach(['name', 'amount', 'created_at','bank_name', 'bank_account_holder_name', 'bank_account_number', 'bank_ifsc_code', 'bank_address', 'routing_number', 'bank_iban','bank_swift'] as $column)
                            <div class="d-flex">
...
<script>
    $(document).ready(function() {
        $('#downloadBtn').on('click', function() {
            ...
            var url = '{{ route("download-withdrawexcel", ":file_type") }}'.replace(':file_type', fileType);
