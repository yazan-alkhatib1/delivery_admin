                ...
                <form id="exportForm" method="get">
                    ...
                    <div class="row">
                        <div class="col-md-6 mr-4">
                            @foreach(['traking_id','order_id', 'user', 'delivery_man_excel','city_name', 'pickup_date_time_excel', 'delivery_date_time_excel', 'total_amount_excel', 'commission_type_excel', 'admin_commission_excel', 'delivery_man_commission_excel'] as $column)
                                <div class="d-flex">
...
<script>
    $(document).ready(function() {
        ...
        $('#downloadBtn').on('click', function() {
            var cityId = $('#exportModal').data('cityId');
            ...
            var baseUrl = '{{ url('/') }}';
            var route = fileType === 'pdf' ? 'report_of_citypdf' : 'report-of-cityexcel/' + fileType;
